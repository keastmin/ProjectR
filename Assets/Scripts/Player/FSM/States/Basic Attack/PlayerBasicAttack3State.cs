...
public class PlayerBasicAttack3State : PlayerStateBase
{
    ...
    private string _animPath = "Base Layer.Basic Attack.Basic Attack 3";
    private int _animHash;

    public PlayerBasicAttack3State(PlayerCore player) : base(player)
    {
    ...
    public override void UpdateTick()
    {
        ...
        {
            Core.StateMachine.Transition(Core.StateMachine.BasicAttack4State, "IsBasicAttack");
            return;
        }
